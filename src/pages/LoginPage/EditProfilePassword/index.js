...
export const EditProfilePassword = () => {
    ...
    const editUser = async e => {
        ...
        await api.put("/game/auth/players/edit-profile-password", { password }, headers)
            .then((response) => {
                setStatus({
                    type: 'redSuccess',
                ...
                <div className="wrapper">
                    <div className="row">
                        ...
                        <div className="top-content-adm">
                            <span className="title-content">Edit password</span>
                            <div className="top-content-adm-right">
                                <Link to="/game/auth/players/view-profile">
                                    <button type="button" className="btn-primary">Profile</button>
                                </Link>
                            </div>
                        </div>
                            ...
                            <form onSubmit={editUser} className="form-adm">
                                ...
                                <div className="row-input">
                                    <div className="column">
                                        ...
                                        <input type="password" name="password" id="password" className="input-adm" placeholder="Password" autoComplete="on" onChange={text => setPassword(text.target.value)} />
                                    </div>
                                </div>
